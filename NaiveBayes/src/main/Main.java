...
public class Main {
	...
	public static void main(String[] args) {
		...
		DataSource dataSourceTest = new DataSource("data/weather.nominal.arff");
		Instances instancesTest = dataSourceTest.getDataSet();
		...
		instancesTest.setClassIndex(instancesTest.numAttribute() - 1);
...
//		System.out.println("-------------------------------------------------------------------------------");
		...
		naiveBayes.testClassifier(instancesTest);
		System.out.println("-----------------------------------------------------------------------------");
	}
